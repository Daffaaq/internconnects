...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('landingpage') }}/css/orange.css" id="theme-color">
</head>
            ...
            <div class="row mt-6">
                ...
                <div class="col-md-5">
                    <div class="slick-about">
                        <img src="{{ asset('landingpage') }}/img/blog-1.jpg" class="img-fluid rounded d-block mx-auto"
                            alt="Work 1" />
                        <img src="{{ asset('landingpage') }}/img/blog-2.jpg" class="img-fluid rounded d-block mx-auto"
                            alt="Work 2" />
                        <img src="{{ asset('landingpage') }}/img/blog-3.jpg" class="img-fluid rounded d-block mx-auto"
                            alt="Work 3" />
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{ asset('landingpage') }}/img/blog-1.jpg"
                                alt="Blog 1">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{ asset('landingpage') }}/img/blog-2.jpg"
                                alt="Blog 2">
                        </a>
                        <div class="card-body">
                            <a href="#" class="card-title mb-2">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a href="#">
                            <img class="card-img-top img-raised" src="{{ asset('landingpage') }}/img/blog-3.jpg"
                                alt="Blog 3">
                        </a>
                        <div class="card-body">
                            <a href="#" class="card-title mb-2">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-12 text-muted text-center small-xl">
                    &copy; 2023 Knight - All Rights Reserved
                </div>
            </div>
        </div>
    </footer>
